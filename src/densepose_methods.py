...
class DensePoseMethods:
    def __init__(self):
        #
        ALP_UV = loadmat( os.path.join(os.path.dirname(__file__), '../models/UV_Processed.mat')  )
        ...
        UV_symmetry_filename = os.path.join(os.path.dirname(__file__), '../models/UV_symmetry_transforms.mat')
    ...
    def FBC2PointOnSurface( self, FaceIndex, bc1,bc2,bc3,Vertices ):
        ...
        ##
        return(p, ((Vert_indices[0], bc1), (Vert_indices[1], bc2), (Vert_indices[2], bc3)))
